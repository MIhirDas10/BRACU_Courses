...
{
       0,    53,    53,    62,    69,    78,    85,    95,    94,   160,
     159,   197,   212,   226,   242,   261,   260,   302,   301,   340,
     380,   387,   394,   401,   410,   425,   441,   456,   476,   483,
     492,   499,   507,   514,   521,   528,   535,   542,   549,   568,
     577,   584,   593,   626,   671,   684,   721,   730,   758,   766,
     794,   803,   838,   847,   920,   928,   955,   964,   976,   985,
    1040,  1049,  1058,  1067,  1076,  1087,  1100,  1110,  1124
};
#endif
...
#line 95 "22299480_22101811.y"
    {
			...
			*/
			for(int i=0; i<(int)paramname.size(); i++)
			{
				...
				for(int j=0; j<i; j++)
				{
					...
					{
						outlog<<"At line no: "<<lines<<" Multiple declaration of variable "<<paramname[i]<<" in parameter of "<<(yyvsp[(2) - (5)])->getname()<<endl<<endl;
						outerror<<"At line no: "<<lines<<" Multiple declaration of variable "<<paramname[i]<<" in parameter of "<<(yyvsp[(2) - (5)])->getname()<<endl<<endl;
						error_count++;
						break;
					}
				}
			...
			*/
			symbol_info *s = new symbol_info((yyvsp[(2) - (5)])->getname(), "ID");
			s->setidtype("function");
			s->setreturntype((yyvsp[(1) - (5)])->getname());
			s->set_parameters(paramtype, paramname);
			if(!st->insert(s))
			{
				outlog<<"At line no: "<<lines<<" Multiple declaration of function "<<(yyvsp[(2) - (5)])->getname()<<endl<<endl;
				outerror<<"At line no: "<<lines<<" Multiple declaration of function "<<(yyvsp[(2) - (5)])->getname()<<endl<<endl;
				error_count++;
				delete s;
			}
...
#line 160 "22299480_22101811.y"
    {
			...
			*/
			...
			symbol_info *s = new symbol_info((yyvsp[(2) - (4)])->getname(), "ID");
			s->setidtype("function");
			s->setreturntype((yyvsp[(1) - (4)])->getname());
			s->set_parameters(paramtype, paramname);
			if(!st->insert(s))
			{
				outlog<<"At line no: "<<lines<<" Multiple declaration of function "<<(yyvsp[(2) - (4)])->getname()<<endl<<endl;
				outerror<<"At line no: "<<lines<<" Multiple declaration of function "<<(yyvsp[(2) - (4)])->getname()<<endl<<endl;
				error_count++;
				delete s;
			}
...
#line 198 "22299480_22101811.y"
    {
			...
			/*
				...
				function-body scope.
			*/
			paramtype.push_back((yyvsp[(3) - (4)])->getname());
...
#line 213 "22299480_22101811.y"
    {
			...
			*/
			paramtype.push_back((yyvsp[(3) - (3)])->getname());
			paramname.push_back("");
...
#line 227 "22299480_22101811.y"
    {
			...
			*/
			paramtype.clear();
			paramname.clear();
			paramtype.push_back((yyvsp[(1) - (2)])->getname());
...
#line 243 "22299480_22101811.y"
    {
			...
			*/
			paramtype.clear();
			paramname.clear();
			paramtype.push_back((yyvsp[(1) - (1)])->getname());
			paramname.push_back("");
...
#line 341 "22299480_22101811.y"
    {
			...
			*/
			for(int i=0; i<(int)decl_list.size(); i++)
			{
				...
				{
					decl_list[i]->setvartype((yyvsp[(1) - (3)])->getname());
				}
...
#line 411 "22299480_22101811.y"
    {
			...
			*/
			symbol_info *s = new symbol_info((yyvsp[(3) - (3)])->getname(), "ID");
			s->setidtype("var");
...
#line 426 "22299480_22101811.y"
    {
			...
			*/
			symbol_info *s = new symbol_info((yyvsp[(3) - (6)])->getname(), "ID");
			s->setidtype("array");
			s->setarraysize(atoi((yyvsp[(5) - (6)])->getname().c_str()));
            decl_list.push_back(s);
...
#line 442 "22299480_22101811.y"
    {
            ...
            */
            decl_list.clear();
			symbol_info *s = new symbol_info((yyvsp[(1) - (1)])->getname(), "ID");
			s->setidtype("var");
			decl_list.push_back(s);
...
#line 457 "22299480_22101811.y"
    {
            ...
            */
            decl_list.clear();
			symbol_info *s = new symbol_info((yyvsp[(1) - (4)])->getname(), "ID");
			s->setidtype("array");
			s->setarraysize(atoi((yyvsp[(3) - (4)])->getname().c_str()));
			decl_list.push_back(s);
...
#line 550 "22299480_22101811.y"
    {
			...
			*/
			symbol_info *found = st->lookup((yyvsp[(3) - (5)])->getname());
			if(found == NULL)
			{
...
#line 594 "22299480_22101811.y"
    {
		...
		*/
		symbol_info *found = st->lookup((yyvsp[(1) - (1)])->getname());
		if(found == NULL)
		{
		...
		{
			(yyval)->setvartype(found->getvartype());
		}
...
#line 627 "22299480_22101811.y"
    {
		...
		*/
		symbol_info *found = st->lookup((yyvsp[(1) - (4)])->getname());
		if(found == NULL)
		{
		...
		else
		{
			...
			if((yyvsp[(3) - (4)])->getvartype() != "int" && (yyvsp[(3) - (4)])->getvartype() != "" && (yyvsp[(3) - (4)])->getvartype() != "error")
			{
...
#line 685 "22299480_22101811.y"
    {
			...
			*/
			...
			else if((yyvsp[(1) - (3)])->getvartype() != "" && (yyvsp[(1) - (3)])->getvartype() != "error" && (yyvsp[(3) - (3)])->getvartype() != "" && (yyvsp[(3) - (3)])->getvartype() != "error")
			{
				if((yyvsp[(1) - (3)])->getvartype() == "int" && (yyvsp[(3) - (3)])->getvartype() == "float")
				{
...
#line 804 "22299480_22101811.y"
    {
			...
			*/
			if((yyvsp[(1) - (3)])->getvartype() == "" || (yyvsp[(1) - (3)])->getvartype() == "error" || (yyvsp[(3) - (3)])->getvartype() == "" || (yyvsp[(3) - (3)])->getvartype() == "error")
			{
				(yyval)->setvartype("error");
			}
			else if((yyvsp[(1) - (3)])->getvartype() == "void" || (yyvsp[(3) - (3)])->getvartype() == "void")
			{
				outlog<<"At line no: "<<lines<<" operation on void type "<<endl<<endl;
				outerror<<"At line no: "<<lines<<" operation on void type "<<endl<<endl;
				error_count++;
...
#line 848 "22299480_22101811.y"
    {
			...
			*/
			if(op == "%")
			{
				...
				else if((yyvsp[(3) - (3)])->getname() == "0" || (yyvsp[(3) - (3)])->getname() == "0.0" || (yyvsp[(3) - (3)])->getname() == "0.00")
				{
			...
			{
				if(op == "/" && ((yyvsp[(3) - (3)])->getname() == "0" || (yyvsp[(3) - (3)])->getname() == "0.0" || (yyvsp[(3) - (3)])->getname() == "0.00"))
				{
...
#line 929 "22299480_22101811.y"
    {
			...
			*/
			...
			else if((yyvsp[(2) - (2)])->getvartype() == "" || (yyvsp[(2) - (2)])->getvartype() == "error")
			{
				(yyval)->setvartype("error");
			}
			else
...
#line 986 "22299480_22101811.y"
    {
		...
		*/
		...
		else if(found->getidtype() != "function" && found->getidtype() != "func")
		{
			...
			outerror<<"At line no: "<<lines<<" "<<(yyvsp[(1) - (4)])->getname()<<" is not a function"<<endl<<endl;
			error_count++;
			(yyval)->setvartype("error");
		}
		else
		{
			...
			vector<string> got = (yyvsp[(3) - (4)])->getparamtype();
			...
			else
			{
				for(int i=0; i<(int)expected.size(); i++)
				{
					...
					{
						outlog<<"At line no: "<<lines<<" argument "<<to_string(i+1)<<" type mismatch in function call: "<<(yyvsp[(1) - (4)])->getname()<<endl<<endl;
						outerror<<"At line no: "<<lines<<" argument "<<to_string(i+1)<<" type mismatch in function call: "<<(yyvsp[(1) - (4)])->getname()<<endl<<endl;
						error_count++;
					}
				}
			}
			(yyval)->setvartype(found->getreturntype());
		}
	}
    break;
...
#line 1088 "22299480_22101811.y"
    {
					...
					*/
					(yyval)->set_parameters((yyvsp[(1) - (1)])->getparamtype(), vector<string>());
			  }
    break;

  case 66:
/* Line 1792 of yacc.c  */
#line 1100 "22299480_22101811.y"
    {
					...
					(yyval)->set_parameters(vector<string>(), vector<string>());
			  }
    break;

  case 67:
/* Line 1792 of yacc.c  */
#line 1111 "22299480_22101811.y"
    {
				...
				*/
				vector<string> types = (yyvsp[(1) - (3)])->getparamtype();
				types.push_back((yyvsp[(3) - (3)])->getvartype());
				(yyval)->set_parameters(types, vector<string>());
		  }
    break;

  case 68:
/* Line 1792 of yacc.c  */
#line 1125 "22299480_22101811.y"
    {
				...
				vector<string> types;
				types.push_back((yyvsp[(1) - (1)])->getvartype());
				(yyval)->set_parameters(types, vector<string>());
		  }
    break;
